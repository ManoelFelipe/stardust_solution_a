...
-- Name: stardust_solution_a; Type: DATABASE; Schema: -; Owner: postgres
--

-- CREATE DATABASE stardust_solution_a WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLLATE = 'Portuguese_Brazil.1252' LC_CTYPE = 'Portuguese_Brazil.1252';


ALTER DATABASE stardust_solution_a OWNER TO postgres;

--\connect stardust_solution_a
